...
public class LoginActivity extends Activity /*implements LoaderCallbacks<Cursor> */{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // populateAutoComplete();
        ...
        TxVwSignUp = (TextView) findViewById(R.id.link_sign_up);
        TxVwSignUp.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ActivitySignUp=new Intent(LoginActivity.this, SignUpActivity.class);
  ...
  /*  @Override
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            mEmailView.setError("Complete el campo");
    ...
    private String existenCredenciales_email(String email)
    {
        ...
        String query = "select idusuario, nombre, apellido, username, email, password, direccion, telefono from usuarios where email ='"+email+"'";

        UsuarioTraido = BaseDeDatos.rawQuery(query,null);
   ...
   /* private void ActualizarIniciado(String email)
    {
        ...
        registroAModificar.put("iniciado",1);
